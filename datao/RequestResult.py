class RequestResult:
    def __init__(self, request, response):
        ...
        self._volume = request.get('volume', None)  # Default to None
        self._price = request.get('price', None)  # Default to None
        self._comment = request.get('comment', '')
        self._server_response_message = getattr(response, 'comment', '')
        self._symbol = request.get('symbol', '')
        self._sl = request.get('sl', None)  # Default to None
        self._tp = request.get('tp', None)  # Default to None
        self._magic_number = request.get('magic', None)  # Default to None
